...
<div>
<form class="register_container" action="Update2" method="post">
	
	Name :<input type="text" name="name" value="${student.name}"><br>
	Father's name :<input type="text" name="father" value="${student.father}"><br>
	Mother's name:<input type="text" name="mother" value="${student.mother}"><br>
	City:<input type="text" name="city" value="${student.city}"><br>
	State :<input type="text" name="state" value="${student.state}"><br>
	Contact number :<input type="text" name="phone" value="${student.phone}"><br>
